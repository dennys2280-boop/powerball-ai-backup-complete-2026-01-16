...
export default function PowerballRobotCoach(props: {
  ...
  async function autopilot, comparar estrategias(maxTries = 4) {
  ...
  function handleText(text: string) {
    ...
    switch (intent.type) {
      ...
      case "autopilot, comparar estrategias":
        autopilot, comparar estrategias();
        return;

      case "help":
        say(
          "Comandos: 'modo torneo', 'modo calendario pro', 'autopilot pro', 'recomiéndame ajustes', 'guarda este pack', 'mis packs', 'marca jugada 3', 'mis favoritos', 'modo lectura lenta', 'english mode'.

Comandos: 'modo entrevista', 'pack inteligente', 'modo estricto', 'anti similares nivel 2', 'solo 10 a 60', 'máximo 2 del último sorteo', 'pb no repetido en 10', 'mínimo 2 números 50+', 'modo playground', 'modo conservador', 'modo agresivo', 'explica jugada 3', 'autopilot, comparar estrategias', ventanas 2 5 10, 10 jugadas, seed 123, más diversidad, más overdue, solo secuencias, ejecuta, explica resultados, cambia 34 por 41, powerball 12, rescore."
        );
        return;
      default:
